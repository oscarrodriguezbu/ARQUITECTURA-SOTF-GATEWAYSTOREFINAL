...
describe('Stock e2e test', () => {
  ...
  it('should load Stocks', async () => {
    ...
    expect(await stockComponentsPage.getTitle()).to.eq('gatewaystoreApp.inventariomicroservicioStock.home.title');
  ...
  it('should load create Stock page', async () => {
    ...
    expect(await stockUpdatePage.getPageTitle()).to.eq('gatewaystoreApp.inventariomicroservicioStock.home.createOrEditLabel');
  ...
  it('should delete last Stock', async () => {
    ...
    expect(await stockDeleteDialog.getDialogTitle()).to.eq('gatewaystoreApp.inventariomicroservicioStock.delete.question');
