...
describe('Producto e2e test', () => {
  ...
  it('should load Productos', async () => {
    ...
    expect(await productoComponentsPage.getTitle()).to.eq('gatewaystoreApp.inventariomicroservicioProducto.home.title');
  ...
  it('should load create Producto page', async () => {
    ...
    expect(await productoUpdatePage.getPageTitle()).to.eq('gatewaystoreApp.inventariomicroservicioProducto.home.createOrEditLabel');
  ...
  it('should delete last Producto', async () => {
    ...
    expect(await productoDeleteDialog.getDialogTitle()).to.eq('gatewaystoreApp.inventariomicroservicioProducto.delete.question');
